...
def test_create_duplicated_normalization_profile(app_auth, client_auth_with_token):
    from wazo_router_confd.database import SessionLocal
...
def test_get_normalization_profile(app_auth, client_auth_with_token):
    from wazo_router_confd.database import SessionLocal
    from wazo_router_confd.models.normalization import NormalizationProfile
    from wazo_router_confd.models.tenant import Tenant
...
def test_get_normalization_profile_not_found(app_auth, client_auth_with_token):
    response = client_auth_with_token.get("/1.0/normalization-profiles/1")
...
def test_update_normalization_profile(app_auth, client_auth_with_token):
    from wazo_router_confd.database import SessionLocal
    from wazo_router_confd.models.normalization import NormalizationProfile
    from wazo_router_confd.models.tenant import Tenant
...
def test_update_normalization_profile_not_found(app_auth, client_auth_with_token):
    response = client_auth_with_token.put(
...
def test_delete_normalization_profile(app_auth, client_auth_with_token):
    from wazo_router_confd.database import SessionLocal
    from wazo_router_confd.models.normalization import NormalizationProfile
    from wazo_router_confd.models.tenant import Tenant
...
def test_delete_normalization_profile_not_found(app_auth, client_auth_with_token):
    response = client_auth_with_token.delete("/1.0/normalization-profiles/1")
    assert response.status_code == 404
