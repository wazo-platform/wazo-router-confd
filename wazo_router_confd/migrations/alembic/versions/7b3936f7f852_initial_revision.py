...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('carrier_trunks',
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('carrier_trunks_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('sip_proxy', sa.VARCHAR(length=128), autoincrement=False, nullable=False),
    sa.Column('sip_proxy_port', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('ip_address', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    sa.Column('registered', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('auth_username', sa.VARCHAR(length=35), autoincrement=False, nullable=True),
    sa.Column('auth_password', sa.VARCHAR(length=192), autoincrement=False, nullable=True),
    sa.Column('realm', sa.VARCHAR(length=64), autoincrement=False, nullable=True),
    sa.Column('registrar_proxy', sa.VARCHAR(length=128), autoincrement=False, nullable=True),
    sa.Column('from_domain', sa.VARCHAR(length=64), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['carrier_id'], ['carriers.id'], name='carrier_trunks_carrier_id_fkey', ondelete='CASCADE'),
    ...
    op.create_index('ix_carrier_trunks_carrier_id', 'carrier_trunks', ['carrier_id'], unique=False)
    op.create_table('routing_groups',
    ...
    sa.ForeignKeyConstraint(['routing_rule'], ['routing_rules.id'], name='routing_groups_routing_rule_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['tenant_id'], ['tenants.id'], name='routing_groups_tenant_id_fkey', ondelete='CASCADE'),
    ...
    sa.Column('tenant_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('name', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['tenant_id'], ['tenants.id'], name='carriers_tenant_id_fkey', ondelete='CASCADE'),
    ...
    op.create_table('ipbx',
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('ipbx_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('tenant_id', sa.INTEGER(), autoincrement=False, nullable=False),
    ...
    sa.Column('password', sa.VARCHAR(length=192), autoincrement=False, nullable=True),
    sa.Column('password_ha1', sa.VARCHAR(length=64), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['tenant_id', 'domain_id'], ['domains.tenant_id', 'domains.id'], name='ipbx_tenant_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['tenant_id'], ['tenants.id'], name='ipbx_tenant_id_fkey1', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='ipbx_pkey'),
    sa.UniqueConstraint('tenant_id', 'domain_id', 'username', name='ipbx_tenant_id_domain_id_username_key'),
    ...
    sa.Column('call_start', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('duration', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['carrier_trunk_id'], ['carrier_trunks.id'], name='cdrs_carrier_trunk_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['ipbx_id'], ['ipbx.id'], name='cdrs_ipbx_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['tenant_id'], ['tenants.id'], name='cdrs_tenant_id_fkey', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['tenant_id'], ['tenants.id'], name='domains_tenant_id_fkey', ondelete='CASCADE'),
    ...
    sa.Column('carrier_trunk_id', sa.INTEGER(), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['carrier_trunk_id'], ['carrier_trunks.id'], name='dids_carrier_trunk_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['tenant_id', 'ipbx_id'], ['ipbx.tenant_id', 'ipbx.id'], name='dids_tenant_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['tenant_id'], ['tenants.id'], name='dids_tenant_id_fkey1', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='dids_pkey'),
    sa.UniqueConstraint('tenant_id', 'did_regex', name='dids_tenant_id_did_regex_key')
    )
    ...
    sa.Column('ipbx_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('did_regex', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    sa.Column('route_type', sa.VARCHAR(length=10), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['carrier_trunk_id'], ['carrier_trunks.id'], name='routing_rules_carrier_trunk_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['ipbx_id'], ['ipbx.id'], name='routing_rules_ipbx_id_fkey', ondelete='CASCADE'),
